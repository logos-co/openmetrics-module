{
  ...
  # at the repo root, next to this flake). It declares an interface_dependency on
  # `metrics_source` (interfaces/metrics_source.h) — no concrete module dependency
  # — and binds it to operator-chosen module names at runtime.
  #
